    ...
    >
      ...
      <div ref={breadcrumbRef} className="opacity-0 mb-6">
        <div className="flex items-center gap-2 font-['JetBrains_Mono'] text-[0.75rem] tracking-[0.08em] text-[#5A5570]">
          ...
          <span>/</span>
          <span className="text-[#8A85A0]">Architecture</span>
        </div>
      </div>
      ...
      >
        A modular, secure, and extensible foundation for AI agents. Every layer is replaceable, every connection is standardized.
      </p>
